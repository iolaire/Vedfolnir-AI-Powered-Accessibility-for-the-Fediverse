...
def data_export():
    ...
    if validate_form_submission(form):
        try:
            ...
            send_success_notification('Your data export request has been submitted successfully.', 'Request Submitted')
...
def data_erasure():
    ...
    if validate_form_submission(form):
        try:
            # Basic form submission handling
            send_success_notification('Your data erasure request has been submitted successfully.', 'Request Submitted')
...
def data_rectification():
    ...
    if validate_form_submission(form):
        try:
            # Basic form submission handling
            send_success_notification('Your data rectification request has been submitted successfully.', 'Request Submitted')
...
def data_portability():
    ...
    if validate_form_submission(form):
        try:
            # Basic form submission handling
            send_success_notification('Your data portability request has been submitted successfully.', 'Request Submitted')
