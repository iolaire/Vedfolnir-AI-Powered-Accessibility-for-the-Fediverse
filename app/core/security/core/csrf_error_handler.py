...
from app.core.security.monitoring.csrf_security_metrics import track_csrf_violation
...
class CSRFErrorHandler:
    ...
    def _create_html_error_response(self, error_type: str, context: CSRFValidationContext, 
        ...
        from app.services.notification.helpers.notification_helpers import send_error_notification, send_info_notification
    ...
    def log_csrf_violation(self, error: Exception, context: CSRFValidationContext) -> None:
        ...
        try:
            ...
            try:
                from app.core.security.logging.security_audit_logger import get_security_audit_logger
