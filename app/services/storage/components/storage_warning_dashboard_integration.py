...
# from app.services.admin.components.admin_storage_dashboard import AdminStorageDashboard  # Circular import - commented out
...
class StorageWarningDashboardIntegration:
    ...
    def __init__(self,
                 ...
                 admin_dashboard: Optional[Any] = None,
