...
from app.services.admin.components.admin_system_health_notification_handler import AdminSystemHealthNotificationHandler
...
class AdminDashboardHealthIntegration:
    ...
    def send_health_update_notification(self, user_id: int, force_update: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            from app.services.notification.manager.unified_manager import AdminNotificationMessage, NotificationType, NotificationPriority, NotificationCategory
